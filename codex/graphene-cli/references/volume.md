...
2. Files larger than 5 GiB are still allowed, but the CLI prints a warning first.
3. Agents should treat `5+ GiB` uploads as risky and prefer a smaller split or alternate transfer path when practical.
